# Atividade 06 - Implantação dos programas ASP.NET Core

Nesta atividade iremos configurar um pipeline de release para implantar os programas ASP.NET Core.
...
Acessar o Azure DevOps e abrir o projeto HandsOnDevOpsNETCore. Clicar na opção **Pipelines**, depois na opção **Releases** e depois na opção **New pipeline**.

![new pipeline](../imagens/releasecore1.png)

Clicar na opção **Empty job**.

![empty](../imagens/releasecore2.png)
...
| Campo | Valor | 
| --- | --- |
| Project | HandsOnDevOpsNETCore |
| Source (build pipeline) | HandsOnDevOpsNETCore |
| Default version | Latest |
| Source alias | _HandsOnDevOpsNETCore |

![add artifact](../imagens/releasecore3.png)

Clique no ícone de raio no box **Artifacts**.

![add trigger](../imagens/releasecore4.png)
...
| Archive file patterns | $(System.DefaultWorkingDirectory)/_HandsOnDevOpsNETCore/drop/s.zip |
| Destination folder | $(Agent.WorkFolder)/webzip |

![extract prop](../imagens/releasecore6.png)

Nessa tarefa estamos descompactando o arquivo s.zip que foi baixado do Azure Pipelines para a VM do agente no diretório **_HandsOnDevOpsNETCore/drop**  e vai ser descompactado no diretório **webzip**.
...
| Source Folder | $(Agent.WorkFolder)/webzip |
| Contents | ** |
| Target Folder | c:\inetpub\wwwroot |

Marcar a opção **Overwrite**.

![copy prop](../imagens/releasecore7.png)
